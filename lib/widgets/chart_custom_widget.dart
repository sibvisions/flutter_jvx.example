...
class ChartCustomWidget extends StatefulWidget
{
    ...
    @override
    _ChartCustomWidgetState createState()
    => _ChartCustomWidgetState();
}
...
class _ChartCustomWidgetState extends State<ChartCustomWidget>
{
    ...
    bool animate = false;
    List<charts.Color> color = [charts.Color(r: 48, g: 144, b: 240, a:220),
                ...
                body: TabBarView(
                    children: <Widget>[
                        ...
                        Container(
                            ...
                            child: BarChartWidget(widget: widget, color: color, animate: animate))
                    ],
                    ),
                ));
    }
    ...
    Widget build(BuildContext context)
    {
        return Container(
            child: charts.BarChart(
                [
                    new charts.Series<Country, String>(id: 'Countries',
                                                           domainFn: (Country country, _)
                                                           => country.name,
                                                           measureFn: (Country country, _)
                                                           => country.litres,
    ...
    Widget build(BuildContext context)
    {
        return Container(
            child: charts.PieChart(
                [
                    new charts.Series<Country, int>(id: 'Countries',
                                                        domainFn: (Country country, _)
                                                        => country.distance.toInt(),
                                                        measureFn: (Country country, _)
                                                        => country.litres,
                                                        data: widget.countries,
                                                        labelAccessorFn: (Country country, _)
