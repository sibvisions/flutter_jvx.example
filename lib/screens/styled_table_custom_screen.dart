...
class StyledTableCustomScreen extends CustomScreen {
  ...
  StyledTableCustomScreen(String componentId, String templateName) : super(componentId, templateName);
  ...
  void update(Response response) {
    ...
    if (response.responseData != null &&
      ...
      for (int i = 0; i < response.responseData.dataBooks[0].records.length; i++) {
        contacts.add(Contact.fromJson(response.responseData.dataBooks[0].records[i]));
      }
    }
  }
